...
2. Verify all prerequisites are installed and authenticated
3. Review the configuration in each deployment script
4. Check `.env.*` files for missing or invalid values
5. Run individual deployment scripts to isolate the problem
