...
export interface BookingConfirmationEmailTemplateData {
  firstName: string;
  lastName: string;
  bookingUrl: string;
  sessionDate?: string;
...
export function getBookingConfirmationEmailTemplate({
  ...
  sessionDate,
  sessionTime,
}: BookingConfirmationEmailTemplateData): string {
  const title = 'View Your Booking Confirmation';
  const greeting = `Hello ${firstName} ${lastName},`;
  const bodyText = sessionDate && sessionTime
    ? `View your booking confirmation for your session on ${sessionDate} at ${sessionTime}. Click the button below to see all the details.`
    : 'View your booking confirmation. Click the button below to see all the details.';
              ...
              <tr>
                <td style="padding: 40px;">
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 32px 0;">
                    <tr>
                      <td align="center">
                        <a href="${bookingUrl}" style="display: inline-block; padding: 14px 32px; background-color: #0a2941; color: #ffffff; text-decoration: none; border-radius: 6px; font-size: 16px; font-weight: 600; line-height: 1.5; text-align: center;">
                  ...
                  <p style="margin: 8px 0 0; color: #92b9c6; font-size: 14px; line-height: 1.6; word-break: break-all;">
                    <a href="${bookingUrl}" style="color: #92b9c6; text-decoration: underline;">${bookingUrl}</a>
                  </p>
