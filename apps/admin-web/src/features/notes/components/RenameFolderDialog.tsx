...
export function RenameFolderDialog({
  ...
  return (
    <AdminDialogShell
      ...
      footer={
        <>
          ...
          <Button type="submit" form="rename-folder-form" disabled={updateFolder.isPending}>
    ...
    >
      <Form {...form}>
        <form id="rename-folder-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          <FormField
