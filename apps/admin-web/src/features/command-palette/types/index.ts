...
export type CommandPaletteEntityResult = 
  ...
  | { type: 'file'; id: string; data: { id: string; topic_id: string; code: string | null; type: string; file: { filename: string }; topic: { id: string; name: string }; subject: { short_name: string | null; long_name: string | null } } }
