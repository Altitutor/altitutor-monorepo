...
export function StudentViewContent({
  studentId,
  isOpen,
  onClose,
  onStudentUpdated,
  ...
  // Data fetching
  const { data: studentDetails, isLoading: loadingStudent } = useStudentDetails(studentId, isOpen);
    ...
    return (
      <div className="flex justify-center items-center h-full p-6">
        <div className="text-muted-foreground">
          {loadingStudent ? 'Loading...' : 'Student not found'}
        </div>
      </div>
    );
  }
        ...
        {!hideHeader && (
          <div className="flex-shrink-0 border-b bg-background sticky top-0 z-10">
            <div className="px-6 py-4 flex items-center justify-between">
              ...
              <ActionsMenu type="student" {...studentActions} />
            </div>
          ...
          <AlertDialogContent>
            ...
            <div className="py-4">
              <div className="space-y-2">
                <Label>Type <strong>{student.first_name} {student.last_name}</strong> to confirm</Label>
                <Input
