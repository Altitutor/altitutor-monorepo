  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        {/* Right column: Students for selected file */}
        <div className="space-y-3">
          ...
          {topicFiles.map((file) => {
            ...
            return (
              <div key={file.topicsFilesId} className="space-y-2">
                <div className="text-xs font-medium text-muted-foreground font-mono">{fileCode}</div>
                    ...
                    .map((studentId) => {
                      ...
                      return (
                        <button
                          ...
                          className="w-full text-left p-2 border border-dashed rounded-md text-sm hover:bg-brand-lightBlue/10 dark:hover:bg-brand-dark-card/70"
                        >
