...
export function useFlashcardMutations(topicId: string | null, collectionId: string | null) {
  ...
  return {
    createCollection: useMutation({ mutationFn: flashcardsApi.createCollection, onSuccess: invalidateCollections }),
    deleteCollection: useMutation({ mutationFn: flashcardsApi.deleteCollection, onSuccess: invalidateCollections }),
    updateCollection: useMutation({ mutationFn: flashcardsApi.updateCollection, onSuccess: invalidateCollections }),
