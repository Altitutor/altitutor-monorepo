...
import { ArrowRightLeft, Eye, Link, Loader2, MessageSquare, MoreVertical, Plus, UserMinus } from 'lucide-react';
...
export function ClassStudentsTab({
  ...
  const fetchStudentsForEnrollment = async (): Promise<
    Array<
      Tables<'students'> & {
                ...
                {[...classStudents]
                  ...
                  .map((student) => (
                    <TableRow key={student.id}>
                      ...
                      <TableCell>
                        {new Date(student.enrolled_at).toLocaleDateString('en-AU', {
                      ...
                      <TableCell>
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem onClick={() => openChangeClassModal(student.id)}>
