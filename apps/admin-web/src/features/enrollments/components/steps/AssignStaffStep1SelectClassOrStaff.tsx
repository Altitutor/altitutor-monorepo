...
export function AssignStaffStep1SelectClassOrStaff({
  ...
  // Get selected items for display at top
  ...
  return (
    <div className="flex flex-col flex-1 min-h-0 space-y-4">
      ...
      {/* Show staff card at top for staff context */}
      {context === 'staff' && staff && (
        <div className="mb-4">
          <StaffCard
            staff={staff}
      ...
      {context === 'staff' && selectedClasses.length > 0 && (
        <div className="mb-4 space-y-2">
          <div className="text-sm font-medium text-muted-foreground">Selected Classes:</div>
      ...
      {context === 'class' && selectedStaff.length > 0 && (
        <div className="mb-4 space-y-2">
          <div className="text-sm font-medium text-muted-foreground">Selected Staff:</div>
          {selectedStaff.map(s => {
