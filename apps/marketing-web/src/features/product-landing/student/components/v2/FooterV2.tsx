        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4 md:gap-8 border-b border-white/10 pb-16">
            ...
            <ul className={`space-y-4 text-[#F2F0E9]/80 ${TOKENS.typography.secondarySans}`}>
              <li>
                <AnalyticsLink
                  ...
                  analytics={{ product: "online-learning", placement: "footer", action: "login" }}
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://www.instagram.com/altitutor/" aria-label="Altitutor on Instagram" target="_blank" rel="noreferrer" className="text-[#F2F0E9]/60 hover:text-white transition-colors hover:-translate-y-1">
                <Instagram className="w-6 h-6" />
              </a>
              <a href="https://www.facebook.com/altitutoreducation/" aria-label="Altitutor on Facebook" target="_blank" rel="noreferrer" className="text-[#F2F0E9]/60 hover:text-white transition-colors hover:-translate-y-1">
                <Facebook className="w-6 h-6" />
              </a>
              <a href="https://twitter.com/Altitutor" aria-label="Altitutor on X" target="_blank" rel="noreferrer" className="text-[#F2F0E9]/60 hover:text-white transition-colors hover:-translate-y-1">
                <Twitter className="w-6 h-6" />
              </a>
              <a href="https://www.youtube.com/@altitutor" aria-label="Altitutor on YouTube" target="_blank" rel="noreferrer" className="text-[#F2F0E9]/60 hover:text-white transition-colors hover:-translate-y-1">
