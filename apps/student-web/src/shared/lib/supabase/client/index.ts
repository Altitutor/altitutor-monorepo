...
// Uses unique cookie name 'student-auth' to prevent collision with other apps
 ...
 * - Browser: Returns browser client with cookie handling (memoized, uses 'student-auth' cookie)
