...
export function PhilosophySectionV2() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative z-20 -mt-10 flex min-h-screen w-full flex-col justify-center overflow-hidden rounded-b-[3rem] rounded-t-none bg-[#1A1A1A] py-40 text-[#F2F0E9] shadow-2xl"
    >
