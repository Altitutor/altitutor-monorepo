...
import { studentOnboardingTours } from '@/features/onboarding/config/tour-steps';
import { useCompleteOnboardingTour } from '@/features/onboarding/hooks/use-onboarding-progress';

// Light: soft navy wash. Dark: neutral dim without tinting the page blue.
