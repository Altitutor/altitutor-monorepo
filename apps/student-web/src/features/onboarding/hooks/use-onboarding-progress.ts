...
type StudentProfileView = Database['public']['Views']['vstudent_profile']['Row'];

export const ONBOARDING_QUERY_KEY = ['student', 'onboarding-progress'] as const;
...
export function useOnboardingProgress() {
  ...
  const enabled = !isAuthLoading && !!session;
