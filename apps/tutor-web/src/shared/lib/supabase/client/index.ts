...
// Uses unique cookie name 'tutor-auth' to prevent collision with other apps
 ...
 * - Browser: Returns browser client with cookie handling (memoized, uses 'tutor-auth' cookie)
