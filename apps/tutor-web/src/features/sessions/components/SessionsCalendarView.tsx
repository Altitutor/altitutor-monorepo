...
export function SessionsCalendarView({ onOpenSession }: Props) {
  ...
  const [sessionDetailsMap, setSessionDetailsMap] = useState<
    Record<string, { staff: SessionStaff[]; students: SessionStudent[] }>
  >({});
  ...
  const showTodayIndicator =
    todayDayIndex >= 0 && currentMinutesFromStart >= 0 && currentMinutesFromStart < slots.length * 60;
    ...
    <div className="flex flex-col">
      ...
      <div className="relative overflow-x-auto">
        ...
        >
          {/* Headers */}
          <div
            className="sticky z-20 p-2 text-center font-medium bg-background border-b border-r text-xs"
            style={{ top: '-1.5rem' }}
          >
            Time
          </div>
                      ...
                      <div className="absolute inset-0" style={{ height: `${slots.length * slotHeight}px` }}>
                        ...
                        {isToday && showTodayIndicator && (
                          <div
                            ...
                            style={{
                              top: `${(currentMinutesFromStart / 60) * slotHeight}px`,
                            }}
                          >
