...
const ucatDropdownChildren: DropdownChild[] = [
  ...
  { title: 'Audits', href: '/ucat/audits', icon: ShieldCheck },
  { title: 'AI content changes', href: '/ucat/content-changes', icon: FileDiff },
...
export default function TutorClientLayout({
  children,
}: {
