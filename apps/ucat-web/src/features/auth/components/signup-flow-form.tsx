...
interface SignupFlowFormProps {
  email: string;
  redirectTo?: string;
}

export function SignupFlowForm({ email, redirectTo = "/subscribe" }: SignupFlowFormProps) {
