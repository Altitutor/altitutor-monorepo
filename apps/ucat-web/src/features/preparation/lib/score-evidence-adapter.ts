...
export const REPRESENTATIVE_SCORE_EVIDENCE_SELECT =
  "evidence_session_id, source, section_id, section_number, completed_at, score_points, total_points, question_count, section_question_count, section_category_count, was_timed, prescribed_pace, observed_pace, breadth, category_ids, feedback_withheld, is_student_generated" as const;
...
export function parseRepresentativeScoreEvidence(
  ...
  return {
    ...
    sectionCategoryCount: row.section_category_count ?? 0,
