...
export function DashboardActivationChecklist() {
  ...
  // Keep the dialog mounted after the last task completes so copy/share does not
  // unmount ReferralDialog with the checklist card.
  if (allComplete && !referralOpen) return null;
