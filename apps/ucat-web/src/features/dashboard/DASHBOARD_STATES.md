...
| Medium/high confidence but no exact test date                                               | History plus 120-day bounded outlook                 | Bounded outlook   | Stored improvement, largest Study plan section gap, or “This is a 120-day outlook” | Reports improvement or a generated section-to-section-target gap when those exist; otherwise explains that the chart shows the next 120 days rather than exam day. Date capture is not the Why. |
| Exact test date is beyond 120 days                                                          | History plus 120-day bounded outlook; no test marker | Bounded outlook   | Stored improvement, largest Study plan section gap, or the forecast-window title   | Same Why family as year-only timing. Fallback explains that exam-day judgement waits until the test is inside the 120-day window.                                                             |
