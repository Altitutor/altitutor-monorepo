    ...
    <UcatExamDialog
      ...
      message={
        <div className="space-y-3 text-left">
          <p>
            Below is a summary of your answers. You can review your questions in
          ...
          <ol className="list-decimal list-inside space-y-1">
            ...
            <li>
              Review questions that are flagged for review. (Click the
              &apos;flag&apos; icon to change the flag for review status.)
            </li>
          </ol>
          <p>
            You may also click on a question number to link directly to its
            location in the exam.
          </p>
        </div>
      }
      actions={
