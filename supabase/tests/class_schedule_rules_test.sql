...
SELECT is(
  (public.preview_class_schedule(jsonb_build_object(
    'schedule_type', 'RECURRING', 'start_date', '2026-09-01', 'end_date', '2026-09-29',
    'effective_from', '2026-09-01', 'timezone', 'Australia/Adelaide',
    'frequency_weeks', 2, 'anchor_date', '2026-09-01',
...
SELECT is(
  (public.preview_class_schedule(jsonb_build_object(
    'schedule_type', 'CUSTOM', 'start_date', '2026-09-01', 'end_date', '2026-09-30',
    'effective_from', '2026-09-01', 'timezone', 'Australia/Adelaide',
    'custom_sessions', jsonb_build_array(
      jsonb_build_object('date', '2026-09-03', 'start_time', '13:00', 'end_time', '14:00'),
      jsonb_build_object('date', '2026-09-17', 'start_time', '15:00', 'end_time', '16:00')
    )
  ))->'counts'->>'create')::INTEGER,
  2,
...
SELECT throws_ok(
  $$ SELECT public.preview_class_schedule(jsonb_build_object(
    'schedule_type', 'RECURRING', 'start_date', '2026-09-01', 'end_date', '2026-09-30',
...
SELECT throws_ok(
  $$ SELECT public.preview_class_schedule(jsonb_build_object(
    ...
    'custom_sessions', jsonb_build_array(
      jsonb_build_object('date', '2026-09-03', 'start_time', '13:00', 'end_time', '14:00'),
      jsonb_build_object('date', '2026-09-03', 'start_time', '13:30', 'end_time', '14:30')
    )
  )) $$,
