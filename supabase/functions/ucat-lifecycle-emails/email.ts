...
function copy(candidate: LifecycleCandidate, campaign: LifecycleCampaign) {
  ...
  switch (campaign.key) {
    ...
    case "onboarding_free_forever":
      return { subject: "You don’t need to pay to keep going", preview: "Free is an ongoing way to practise, not a trial you use up.", heading: "Keep preparing for free", paragraphs: [`Hi ${firstName}, Altitutor UCAT Free is not a short trial or a fixed sample that disappears once you have used it.`, "Your free allowances reset, so you can keep practising, reviewing and building a clearer picture of your progress. Unlimited is there when you want to prepare without waiting."], cta: "Continue preparing", path: "/dashboard", from: "Matt at Altitutor <noreply@altitutor.com>", replyTo: "matt@altitutor.com" };
