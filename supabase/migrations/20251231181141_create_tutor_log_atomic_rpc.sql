-- Migration: Add create_tutor_log RPC function for atomic tutor log creation
-- This function handles creating a tutor log with all related records atomically
