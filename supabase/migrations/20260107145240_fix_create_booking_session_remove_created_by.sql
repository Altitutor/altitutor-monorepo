...
--              This migration fixes the create_booking_session function that was updated in 20260107144007_add_student_status_validation.sql
--              to remove created_by from sessions INSERT and add it to sessions_students INSERT.
