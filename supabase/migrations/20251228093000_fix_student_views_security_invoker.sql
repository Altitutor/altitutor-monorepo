-- Migration: Fix student views to use security_invoker = false
-- Description:
--  Change all vstudent_* views from security_invoker = on to security_invoker = false.
...
--  This is consistent with tutor views pattern.
...
-- ================================================
CREATE VIEW public.vstudent_payment_attempts
WITH (security_invoker = false)
AS
SELECT 
  pa.id,
...
-- COMMENTS
-- ================================================
COMMENT ON VIEW public.vstudent_profile IS 'Student view: Own profile information (security_invoker = false)';
COMMENT ON VIEW public.vstudent_billing IS 'Student view: Own billing information with all payment methods (security_invoker = false)';
COMMENT ON VIEW public.vstudent_classes IS 'Student view: Enrolled classes (security_invoker = false)';
COMMENT ON VIEW public.vstudent_class_detail IS 'Student view: Detailed class info with participants (security_invoker = false)';
COMMENT ON VIEW public.vstudent_sessions IS 'Student view: Sessions for enrolled classes (security_invoker = false)';
COMMENT ON VIEW public.vstudent_session_base IS 'Student view: Base session details (security_invoker = false)';
COMMENT ON VIEW public.vstudent_tutor_log IS 'Student view: Tutor log data for attended sessions (security_invoker = false)';
COMMENT ON VIEW public.vstudent_subjects IS 'Student view: Subjects linked via classes or students_subjects (security_invoker = false)';
COMMENT ON VIEW public.vstudent_subject_resources IS 'Student view: Hierarchical topics and files for student subjects (security_invoker = false)';
COMMENT ON VIEW public.vstudent_payment_attempts IS 'Student view: Payment attempts history (security_invoker = false)';
