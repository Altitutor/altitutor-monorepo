-- Migration: Update reconciliation view to include was_trial fields
-- Description:
--  - Update vadmin_reconciliation_uninvoiced_sessions to include was_trial from sessions_students
--  - Include actual_was_trial from tutor_logs_student_attendance
-- Purpose: Enable frontend to display trial status in reconciliation table
