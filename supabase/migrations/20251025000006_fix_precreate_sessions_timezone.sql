-- Migration: Fix precreate_sessions to use Adelaide timezone
-- Description:
--  - Interpret class times as Adelaide local times (Australia/Adelaide)
--  - Convert to UTC for storage in sessions table

-- ========================
-- UPDATE precreate_sessions FUNCTION WITH ADELAIDE TIMEZONE
-- ========================
