-- Migration: Add relevance-based ranking to search_subjects_admin
-- Description: Prioritize exact matches in subject shortname/longname over individual field matches
-- Ranking priority:
--   1. Exact match in subject shortname
--   2. Starts with search term in subject shortname
--   3. Contains search term in subject shortname
--   4. Exact match in subject longname
--   5. Starts with search term in subject longname
--   6. Contains search term in subject longname
--   7. Individual field matches (name, curriculum, level)
--   8. Fuzzy match
--   9. User-specified ordering fallback
