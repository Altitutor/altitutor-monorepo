-- Migration: Add relevance-based ranking to search_students_admin
-- Description: Prioritize exact matches and matches in name fields over school/class matches
-- Ranking priority:
...
--   10. Contains search term in school
--   11. Fuzzy match
