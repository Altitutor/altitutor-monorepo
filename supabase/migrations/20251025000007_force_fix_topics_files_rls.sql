...
CREATE POLICY adminstaff_all_topics ON topics
  FOR ALL
  TO authenticated
  USING (
    COALESCE(
...
DROP POLICY IF EXISTS adminstaff_all_files ON files;
...
DROP POLICY IF EXISTS adminstaff_all_topics_files ON topics_files;
