...
-- 12. Drop old 6-param overload (references questions_sets), then create new 7-param version (p_name, p_stem_ids)
DROP FUNCTION IF EXISTS public.tutor_ucat_upsert_question_set(UUID, JSONB, INTEGER, BOOLEAN, BOOLEAN, JSONB);
