-- Migration: Update precreate_sessions to create sessions for inactive classes
-- Description:
--   - Remove filter that only creates sessions for ACTIVE classes
--   - Add status field to session creation to match class status
--   - Create sessions for both ACTIVE and INACTIVE classes
