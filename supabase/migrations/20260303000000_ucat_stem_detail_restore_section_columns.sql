-- UCAT: Restore section_instructions_text, section_instructions_time_limit_seconds,
-- section_time_limit_seconds to vstudent_ucat_question_stem_detail.
-- Migration 20260302000000 recreated the view but omitted these columns, causing 400
-- when the question engine selects them.
