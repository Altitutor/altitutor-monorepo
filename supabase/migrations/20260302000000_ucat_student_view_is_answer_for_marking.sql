-- UCAT: Add is_answer to vstudent_ucat_question_stem_detail answer_options
-- Required for marking/results display after exam completion.
-- Students see correct answers only on the marking screen after ending the exam.
