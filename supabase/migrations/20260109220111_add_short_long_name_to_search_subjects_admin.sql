-- Migration: Add short_name and long_name to search_subjects_admin function
-- Description:
--   - Update search_subjects_admin RPC function to include short_name and long_name fields
--   - This ensures subject objects returned from the search function have these fields populated
--   - Fixes issue where subject pills show blank when adding subjects in EditStudentModal

-- ========================
-- UPDATE SEARCH_SUBJECTS_ADMIN FUNCTION
-- ========================
...
COMMENT ON FUNCTION search_subjects_admin IS 'Admin search function for subjects with exact + fuzzy matching on shortname and longname, and filtering by year_level, curriculum, discipline, and level. Returns subjects with short_name and long_name fields.';

-- ========================
-- UPDATE SEARCH_SUBJECTS_PUBLIC FUNCTION
-- ========================
...
COMMENT ON FUNCTION public.search_subjects_public IS 'Public search function for subjects with exact + fuzzy matching on shortname and longname, and filtering by year_level, curriculum, discipline, and level. Returns subjects with short_name and long_name fields. Accessible to anonymous users for trial booking.';
