-- AI-generated stems enter In review, but their audience access should default
-- to Public just like manually authored and bulk-imported stems. Lifecycle
-- status continues to keep them unavailable to students until publication.
