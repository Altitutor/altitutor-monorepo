-- Migration: Fix precreate_sessions function to handle NULL created_by
-- Description:
--  - Make p_created_by optional (accept NULL)
--  - Only set created_by when p_created_by is provided
