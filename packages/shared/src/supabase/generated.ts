  ...
  public: {
    Tables: {
      ...
      flashcards: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["topic_id"]
            isOneToOne: false
            referencedRelation: "vstaff_topic_flashcard_settings"
            referencedColumns: ["topic_id"]
          },
          {
            foreignKeyName: "flashcards_topic_id_fkey"
      ...
      invoices: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["student_subscription_id"]
            isOneToOne: false
            referencedRelation: "vstudent_subscriptions"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      staff: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["current_tier_number"]
            isOneToOne: false
            referencedRelation: "vtutor_pay_tiers"
            referencedColumns: ["tier_number"]
          },
        ]
      }
      ...
      student_question_attempts: {
        ...
        Relationships: [
          {
            foreignKeyName: "student_question_attempts_learning_module_block_id_fkey"
            columns: ["learning_module_block_id"]
            isOneToOne: false
            referencedRelation: "ucat_learning_module_blocks"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "student_question_attempts_learning_module_block_id_fkey"
            columns: ["learning_module_block_id"]
            isOneToOne: false
            referencedRelation: "vstudent_ucat_learning_module_blocks"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "student_question_attempts_learning_module_block_id_fkey"
      ...
      student_skill_trainer_attempts: {
        ...
        Relationships: [
          {
            foreignKeyName: "student_skill_trainer_attempts_learning_module_block_id_fkey"
            columns: ["learning_module_block_id"]
            isOneToOne: false
            referencedRelation: "ucat_learning_module_blocks"
            referencedColumns: ["id"]
      ...
      students_online_access_manual: {
        ...
        Relationships: [
          {
            foreignKeyName: "students_online_access_manual_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "staff"
            referencedColumns: ["id"]
      ...
      topic_flashcard_settings: {
        Row: {
          again_ease_delta: number
          again_interval_days: number
          created_at: string
          ease_min: number
          easy_ease_delta: number
          easy_first_interval_days: number
          easy_multiplier: number
          easy_second_interval_days: number
          good_first_interval_days: number
          good_second_interval_days: number
          hard_ease_delta: number
        ...
        Relationships: [
          {
            foreignKeyName: "topic_flashcard_settings_topic_id_fkey"
            columns: ["topic_id"]
            isOneToOne: true
            referencedRelation: "topics"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "topic_flashcard_settings_updated_by_fkey"
            columns: ["updated_by"]
            isOneToOne: false
            referencedRelation: "staff"
            referencedColumns: ["id"]
      ...
      ucat_learning_module_blocks: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "ucat_learning_module_blocks_question_id_fkey"
            columns: ["question_id"]
            isOneToOne: false
            referencedRelation: "ucat_questions"
            referencedColumns: ["id"]
      ...
      ucat_learning_modules: {
        ...
        Relationships: [
          {
            foreignKeyName: "ucat_learning_modules_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "staff"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ucat_learning_modules_deleted_by_fkey"
            columns: ["deleted_by"]
            isOneToOne: false
            referencedRelation: "staff"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ucat_learning_modules_updated_by_fkey"
            columns: ["updated_by"]
            isOneToOne: false
            referencedRelation: "staff"
            referencedColumns: ["id"]
      ...
      ucat_student_learning_module_block_progress: {
        Row: {
          completed_at: string | null
          id: string
          interaction_state: Json
          learning_module_block_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "ucat_student_learning_module_bloc_learning_module_block_id_fkey"
            columns: ["learning_module_block_id"]
            isOneToOne: false
            referencedRelation: "ucat_learning_module_blocks"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ucat_student_learning_module_block_progress_student_id_fkey"
            columns: ["student_id"]
            isOneToOne: false
            referencedRelation: "students"
            referencedColumns: ["id"]
      ...
      ucat_student_learning_module_progress: {
        Row: {
          completed_at: string | null
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "ucat_student_learning_module_progress_student_id_fkey"
            columns: ["student_id"]
            isOneToOne: false
            referencedRelation: "students"
            referencedColumns: ["id"]
    ...
    Views: {
      ...
      vstaff_topic_flashcard_settings: {
        Row: {
          again_ease_delta: number | null
          again_interval_days: number | null
          ease_min: number | null
          easy_ease_delta: number | null
          easy_first_interval_days: number | null
          easy_multiplier: number | null
          easy_second_interval_days: number | null
          good_first_interval_days: number | null
          good_second_interval_days: number | null
          hard_ease_delta: number | null
      ...
      vtutor_pay_tier_requirements: {
        Row: {
          created_at: string | null
          id: string | null
          params: Json | null
          requirement_kind:
            | Database["public"]["Enums"]["staff_pay_tier_requirement_kind"]
            | null
          sort_order: number | null
      ...
      vtutor_pay_tiers: {
        Row: {
          base_pay_rate_cents: number | null
          created_at: string | null
          currency: string | null
          name: string | null
          tier_number: number | null
      ...
      vtutor_staff_tier_promotions: {
        Row: {
          check_in_session_id: string | null
          created_at: string | null
          from_tier_number: number | null
          id: string | null
          notes: string | null
          outcome:
            | Database["public"]["Enums"]["staff_tier_promotion_outcome"]
            | null
          reviewed_at: string | null
          reviewed_by: string | null
          staff_id: string | null
          to_tier_number: number | null
        }
        Insert: {
          check_in_session_id?: string | null
          created_at?: string | null
    ...
    Functions: {
      ...
      can_student_access_ucat_learning_module: {
        Args: { p_learning_module_id: string }
        Returns: boolean
      }
      ...
      get_my_billing_subsidies: {
        ...
        Returns: {
          billing_type: Database["public"]["Enums"]["billing_type"]
          currency: string
          standard_hourly_cents: number
          subject_id: string
          subject_long_name: string
          subsidy_hourly_cents: number
        }[]
      }
      ...
      student_rate_flashcard_review_card: {
        Args: { p_rating: string; p_review_card_id: string }
        Returns: {
          created_at: string
          due_at: string
          ease_factor: number
        ...
        SetofOptions: {
          from: "*"
          to: "student_flashcard_review_states"
          isOneToOne: true
          isSetofReturn: false
        }
      }
