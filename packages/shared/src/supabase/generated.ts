...
export type Database = {
  public: {
      ...
      conversation_reads: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["conversation_id"]
            isOneToOne: false
            referencedRelation: "vadmin_reconciliation_unread_messages"
    ...
    Views: {
      ...
      vadmin_reconciliation_orphaned_invoice_items: {
        Row: {
      ...
      vadmin_reconciliation_students_without_classes: {
        Row: {
          created_at: string | null
          email: string | null
          first_name: string | null
          has_active_enrollments: boolean | null
      ...
      vadmin_reconciliation_unread_messages: {
        Row: {
          assigned_staff_id: string | null
