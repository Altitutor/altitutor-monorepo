        ...
        class: cn(
          omitTypography
            ? [
                ...
                '[&_h1]:font-semibold [&_h2]:font-semibold [&_h3]:font-semibold [&_h3]:tracking-tight',
                '[&_h1]:mt-7 [&_h1]:mb-1.5 [&_h2]:mt-6 [&_h2]:mb-1 [&_h3]:mt-5 [&_h3]:mb-1',
                '[&_p]:my-2 [&_ul]:my-2 [&_ol]:my-2',
                '[&_li]:my-1',
                '[&_li_ol]:mt-2 [&_li_ul]:mt-2',
                '[&_table]:my-4 [&_th]:border [&_th]:border-border [&_th]:p-2 [&_th]:bg-muted',
          ...
          'cursor-text pl-6',
          /* Preflight clears list markers; editor classes are on view.dom (tiptap/ProseMirror root) */
          ...
          '[&_ul>li>p:empty]:min-h-[1.5em]',
          '[&_ol>li>p:empty]:min-h-[1.5em]',
          '[&_h1:empty]:min-h-[2em]',
          '[&_h2:empty]:min-h-[1.75em]',
          '[&_h3:empty]:min-h-[1.5em]',
          className
        ),
