 ...
 */
export function RichTextEditorBottomToolbar({ editor }: RichTextEditorBottomToolbarProps) {
  ...
  useEffect(() => {
    ...
    const updateToolbarState = () => {
      ...
      setToolbarMode(hasTextSelection ? 'text-selection' : 'default')
    }
  ...
  if (toolbarMode === 'text-selection') {
    return (
      <div className={RICH_TEXT_BOTTOM_TOOLBAR_OUTER_CLASS}>
        <div className={TOOLBAR_INNER_PAD}>
          <div className="inline-flex min-w-full flex-nowrap items-center justify-center gap-1">
            <Button
              type="button"
              variant="ghost"
              size="sm"
